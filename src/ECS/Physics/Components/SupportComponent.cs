...
public record struct SupportComponent : IComponent
{
    ...
    public SupportComponent(Direction4 normals = Direction4.Up, float friction = 0, bool makeTimeless = false, Vector2? overrideRestitution = null, float accelerationMult = 1)
    {
        Friction = friction;
