...
public class TheGame : MonodGame
{
    ...
    public void InitWorld()
    {
        ...
        Store.CreateEntity(new SupportComponent() { Friction = -0.05f }, new MobileComponent() { Velocity = new(0, -100) }, new MobileInfoComponent() { AffectedByGravity = false }, new HitboxComponent(0, 0, 250, 50), new Transform2D(300, 550));
